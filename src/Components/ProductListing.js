...
export default function ProductListing() {
  ...
  var products = [
  {
    ...
    subtitle: "SmartPhone",
    shortDescription: "iPhone X introduces an all‑new glass design. The world’s most popular camera, now even better. The most powerful and smartest chip ever in a smartphone. Wireless charging that’s truly effortless. And augmented reality experiences never before possible.",
